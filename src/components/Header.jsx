...
export default function Header({ post }) {
  ...
  const tagline = 'Παροχή εργασιών πεδίου';
  const quote = 'Έξυπνη ανακύκλωση, καθαρές πόλεις, ενεργοί πολίτες';

  return (
    <header className="relative">
      {/* Фоновое изображение для всего хедера */}
      <div
      ...
      {/* Темный оверлей для всего хедера */}
      <div className="absolute inset-0 bg-[#0d1b1f]/70" />

      {/* Градиентный оверлей для всего хедера */}
      ...
      <div className="relative bg-transparent text-white border-b-2 border-white/60">
        <div className="mx-auto flex h-14 max-w-[1400px] items-center justify-between gap-4 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            {/* Кнопка поиска — видна только на мобиле */}
      ...
      {/* --- Banner с логотипом услуги --- */}
      <div className="relative">
        {/* Эффект свечения справа, где находится текст */}
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <h1 className="font-display text-3xl font-semibold text-white sm:text-4xl md:text-5xl">
                <span className="text-[#7ac142]">Eco</span>
        ...
        {/* нижняя градиентная зелёная полоса */}
