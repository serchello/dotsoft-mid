...
export default function RightSidebar({ videoUrl, pdfUrl, images }) {
  ...
  return (
    <aside className="w-full space-y-8 sticky top-12 self-start">
          ...
          {images.length === 1 ? (
            ...
            <Carousel
              ...
              renderIndicator={(onClickHandler, isSelected, index, label) => {
                ...
                return (
                  <li
                    className="inline-block mx-1 w-2.5 h-2.5 rounded-full cursor-pointer hover:bg-white/70 transition"
                    onClick={onClickHandler}
                    value={index}
                    key={index}
                    role="button"
      ...
      {pdfUrl && (
        <div className="flex justify-center w-full my-4">
          <a
            ...
            className="group mx-auto inline-flex items-center gap-2 px-4 py-3 bg-[#7ac142]/10 text-[#5d9f2b] border border-[#7ac142]/30 rounded-xl shadow-sm hover:shadow-md active:translate-y-0 transition-all duration-200 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#7ac142]/30 focus:ring-offset-2"
          >
